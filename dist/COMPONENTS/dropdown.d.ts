...
export declare const Dropdown: Record<string, ComponentBase>;
export declare function initDropdownStyles(): {
    ".dropdown-dark .dropdown-item": Record<string, any>;
    ".dropdown-dark .dropdown-header": Record<string, any>;
    ".dropdown-dark .dropdown-divider": Record<string, any>;
};
declare const _default: {
    Dropdown: Record<string, ComponentBase>;
    initDropdownStyles: typeof initDropdownStyles;
};
