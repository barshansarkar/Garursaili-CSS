...
export const components: Record<string, ComponentBase> = {
  ...navbar,
  ...Container,
  ...buttons,
  ...card,
...
export function generateComponentVariants(
  baseComponents: Record<string, ComponentBase>,
  count: number = 20
): Record<string, ComponentBase> {
  const dynamicComponents: Record<string, ComponentBase> = {};
...
export const allComponents: Record<string, ComponentBase> = {
  ...components,
