...
import {
  surfaceLight, radiusMd, shadowLg, borderColorLight, blurGlass, radiusLg,
  mergeStyles, surfaceDark, borderColorDark, textDark, standardTransition,
  surfaceAltLight, primary, textLight, surfaceAltDark, primaryLight
} from "../CORECONST"

export const Dropdown: Record<string, ComponentBase> = {
  // Dropdown Trigger
  "dropdown-trigger": {
    base: {
