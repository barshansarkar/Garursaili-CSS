...
import { mergeStyles, surfaceLight, surfaceDark, surfaceAltLight, surfaceAltDark, primary, primaryLight, textDark, textLight, borderColorLight, borderColorDark, radiusMd, radiusLg, shadowLg, blurGlass, standardTransition } from "../CORECONST";

export const Tooltip: Record<string, ComponentBase> = {
