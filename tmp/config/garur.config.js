// src/garur.config.ts
// Default configuration for Garur-CSS with merging of a project-level garur.config.js (if present).
// The project-level file (at project root) may be either garur.config.js exporting an object.
// This module exports the merged config as `config` (and default export).
const defaultConfig = {
    breakpoints: {
        sm: "640px",
        md: "768px",
    ...
    // Full-ish Tailwind-like palette
    palette: {
...
try {
    ...
    // prefer JS file (projects should supply garur.config.js). If they supply TS, they must compile it.
    // This is non-fatal if absent.
