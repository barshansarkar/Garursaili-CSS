import { borderColorDark, borderColorLight, danger, inputBase, mergeStyles, primary, primaryLight, radiusMd, radiusSm, surfaceDark, surfaceLight, surfaceAltLight, success, textLight, warning, blurGlassHeavy, } from "../CORECONST";
export const inputs = {
    input: {
        base: inputBase,
    },
